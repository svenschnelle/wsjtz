...
set (CPACK_RESOURCE_FILE_LICENSE "/home/svens/wsjtz/COPYING")
...
if (CPACK_GENERATOR MATCHES "NSIS")
  ...
  set (CPACK_NSIS_MUI_ICON "/home/svens/wsjtz/icons/windows-icons\\wsjtx.ico")
  set (CPACK_NSIS_MUI_UNIICON "/home/svens/wsjtz/icons/windows-icons\\wsjtx.ico")
  # set the package header icon for MUI
  set (CPACK_PACKAGE_ICON "/home/svens/wsjtz/icons/windows-icons\\installer_logo.bmp")
...
VIFileVersion 2.7.0.0
VIAddVersionKey /LANG=0 \"ProductName\" \"wsjtx\"
VIAddVersionKey /LANG=0 \"ProductVersion\" \"v2.7.0-rc2\"
...
VIAddVersionKey /LANG=0 \"FileVersion\" \"v2.7.0-rc2\""
    )
endif ()
...
if ("${CPACK_GENERATOR}" STREQUAL "DragNDrop")
  ...
  set (CPACK_DMG_BACKGROUND_IMAGE "/home/svens/wsjtz/icons/Darwin/DragNDrop Background.png")
  set (CPACK_DMG_DS_STORE "/home/svens/wsjtz/Darwin/wsjtx_DMG.DS_Store")
  set (CPACK_BUNDLE_NAME "")
  set (CPACK_PACKAGE_ICON "/home/svens/wsjtz/wsjtx.icns")
  set (CPACK_BUNDLE_ICON "/home/svens/wsjtz/wsjtx.icns")
  set (CPACK_BUNDLE_STARTUP_COMMAND "/home/svens/wsjtz/Mac-wsjtx-startup.sh")
endif ()
...
if ("${CPACK_GENERATOR}" STREQUAL "WIX")
  ...
  set (CPACK_PACKAGE_FILE_NAME
    "${CPACK_PACKAGE_NAME}-2.7.0-rc2-${CPACK_SYSTEM_NAME}")
  set (CPACK_SOURCE_PACKAGE_FILE_NAME
    "${CPACK_PACKAGE_NAME}-2.7.0-rc2-Source")
